...
with tab_home:
    st.title("TrackWise – Smart Expense Categorizer & Forecaster")
    ...
    with col1:
        st.markdown(
            """
            **TrackWise** is an AI-based expense tracker, forecaster, and optimizer
    ...
    st.subheader("Plaid-powered TrackWise prototype")
    st.markdown(
        """
        The video below shows a more advanced version of TrackWise where banking and card
